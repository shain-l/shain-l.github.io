$(function () {
  ...
  function search (path) {
    $.ajax({
      // url: GLOBAL_CONFIG.root + path, 修改为
      // url: "https://cdn.jsdelivr.net/gh/你GitHub的用户名/你GitHub的用户名.github.io/search.xml",
      url: "https://cdn.jsdelivr.net/gh/shain-l/shain-l.github.io/search.xml",
      dataType: 'xml',
